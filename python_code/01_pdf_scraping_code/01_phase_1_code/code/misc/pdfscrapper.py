   ...
   # Extract Plant Type, Fuel, and Generator Type
    ...
    if capacity:
     ...
     # Extract Capacity (first occurrence of number followed by MW)
        ...
        capacity = int(capacity.group(1)) if capacity2 else None
        ...
        for page in pdf.pages:
            ...
            if "Table 7-" in text:
                ...
                for table in page_tables:
                    ...
                    required_columns = {"Type of Upgrade", "Upgrade", "Description", "Cost Allocation Factor"}
...
def process_pdfs_in_folder(directory, output_csv_path):
    ...
    for pdf_name in os.listdir(directory):
        if pdf_name.endswith(".pdf"):
            ...
            # Check if the file is in cluster 6 to 9 by looking at the file name
            if re.search(r"C[ _-]?[6-9]", pdf_name, re.IGNORECASE):
...
# Usage
output_csv_path = 'combined_cluster_6_9_data.csv'  # Replace with your desired output path
